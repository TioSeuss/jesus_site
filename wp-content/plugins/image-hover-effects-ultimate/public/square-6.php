...
<?php iheu_font_weight_admin_panel($styledata[53]); ?>
    ...
    echo '<span class="ctu-pro-only">Pro Only</span>';
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-font-familly" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Button Preferred font, Based on Google Font"> Font Family <?php if ($status != 'valid') {
                                                        echo '<span class="ctu-pro-only">Pro Only</span>';
                                                    } ?> </label>
                                            <div class="col-sm-6 nopadding">
