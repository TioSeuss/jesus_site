                            ...
                            <div class="ctu-ultimate-style-3-content">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-5">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="button-font-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Icon Color, Based on Color">Font Color <?php if ($status != 'valid') {   echo '<span class="ctu-pro-only">Pro Only</span>';  } ?></label>
                                            <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="button-font-background" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Icon Background Color, Based on Color">Background Color <?php if ($status != 'valid') {   echo '<span class="ctu-pro-only">Pro Only</span>';  } ?></label>
                                            <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="button-hover-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Icon Hover Color, Based on Color">Hover Color <?php if ($status != 'valid') {   echo '<span class="ctu-pro-only">Pro Only</span>';  } ?></label>
                                            <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="button-hover-background" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Icon Hover background Color, Based on Color">Hover Background <?php if ($status != 'valid') {   echo '<span class="ctu-pro-only">Pro Only</span>';  } ?></label>
                                            <div class="col-sm-6 nopadding">
