...
<?php iheu_item_admin_data($styledata[1]); ?>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="content-height" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Height Of yout Hover Content, After Saved Your data Will ready for Preview" >Content Height</label>
                                            <div class="col-sm-6 nopadding">
