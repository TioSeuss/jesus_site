                            ...
                            <div class="ctu-ultimate-style-3-content">
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-6">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="background-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your image hover background Color, Based on Color">Background <?php
                                                if ($status != 'valid') {
...
<?php iheu_content_alignment_admin_data($styledata[15]); ?>
                                    ...
                                    <div class="iheu-admin-style-settings-div-right">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="image-animation" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Image Vewing Animaion">Image Animation <?php
                                                        if ($status != 'valid') {
                                                            echo '<span class="ctu-pro-only">Pro Only</span>';
                                                        }
                                                        ?></label>
...
<?php iheu_image_animation_admin_data($styledata[19]) ?>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="content-animation" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Choose Your Text Animation">Content Animation <?php
                                                    if ($status != 'valid') {
                                                        echo '<span class="ctu-pro-only">Pro Only</span>';
                                                    }
                                                    ?></label>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="inner-shadow" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Inner Shadow is showing on Image inner, Doesn't want make it 0" >Inner Shadow <?php
                                                if ($status != 'valid') {
                                                    echo '<span class="ctu-pro-only">Pro Only</span>';
                                                }
                                                ?></label>
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-5">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="heading-font-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Change The Title font Color">Font Color <?php
                                                if ($status != 'valid') {
                                                    echo '<span class="ctu-pro-only">Pro Only</span>';
                                                }
                                                ?></label>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="heading-font-familly" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Title Preferred font, Based on Google Font"> Font Family <?php
                                                if ($status != 'valid') {
                                                    echo '<span class="ctu-pro-only">Pro Only</span>';
                                                }
                                                ?></label>
...
<?php iheu_headign_underline_admin_panel($styledata[41]); ?>
                                ...
                                <div class="ctu-ulitate-style-3-tabs " id="ctu-ulitate-style-3-id-4">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="desc-font-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Description Color, Based on Color">Font Color <?php
if ($status != 'valid') {
    echo '<span class="ctu-pro-only">Pro Only</span>';
}
?></label>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="desc-font-familly" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Description Preferred font, Based on Google Font"> Font Family <?php
if ($status != 'valid') {
    echo '<span class="ctu-pro-only">Pro Only</span>';
}
?></label>
...
<?php iheu_font_weight_admin_panel($styledata[53]); ?>
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-3">
                                    <div class="iheu-admin-style-settings-div-left">
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-font-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Button Color, Based on Color">Font Color <?php
                                                if ($status != 'valid') {
                                                    echo '<span class="ctu-pro-only">Pro Only</span>';
                                                }
                                                ?></label>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-font-background" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Button Background Color, Based on Color">Background Color <?php
                                                if ($status != 'valid') {
                                                    echo '<span class="ctu-pro-only">Pro Only</span>';
                                                }
                                                ?></label>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-font-familly" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Button Preferred font, Based on Google Font"> Font Family <?php
                                                if ($status != 'valid') {
                                                    echo '<span class="ctu-pro-only">Pro Only</span>';
                                                }
                                                ?></label>
...
<?php iheu_font_weight_admin_panel($styledata[65]); ?>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-hover-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Button Hover Color, Based on Color">Hover Color <?php
if ($status != 'valid') {
    echo '<span class="ctu-pro-only">Pro Only</span>';
}
?></label>
                                        ...
                                        <div class="form-group row form-group-sm">
                                            <label for="bottom-hover-background" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Button Hover background Color, Based on Color">Hover Background <?php
if ($status != 'valid') {
    echo '<span class="ctu-pro-only">Pro Only</span>';
}
?></label>
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-2">
                                    <div class="iheu-admin-style-settings-div-css">
                                        <div class="form-group">
                                            <label for="iheu-css">Add Your Custom CSS Code Here <?php
if ($status != 'valid') {
    echo '<span class="ctu-pro-only">Pro Only</span>';
}
?></label>
