...
if ( substr_count( $content, '[vc_single_image' ) ) {
	$content = uncode_replace_inner_single_width( $content, $width_media, 'vc_single_image' );
}

if ( substr_count( $content, '[vc_gallery' ) ) {
	$content = uncode_replace_inner_single_width( $content, $width_media, 'vc_gallery' );
}

if ( substr_count( $content, '[uncode_index' ) ) {
	$content = uncode_replace_inner_single_width( $content, $width_media, 'uncode_index' );
}
